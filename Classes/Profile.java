    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == editButton) {
            ...
            if (editButton.getText().equals("Edit")) {
                ...
                System.out.println(details.findDetails(3, user));
                if (t_first.getText().isEmpty()==false || t_phone.getText().contains("+880") || t_phone.getText().length() == 14||t_phone.getText().contains("+88017")|| t_phone.getText().contains("+88018") || t_phone.getText().contains("+88019") || t_phone.getText().contains("+88016") || t_phone.getText().contains("+88013") || t_phone.getText().contains("+88015")) {
