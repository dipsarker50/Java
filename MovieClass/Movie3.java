...
public class Movie3 extends MovieDetails implements ActionListener {
    ...
    public Movie3(String moviename,String user){
       ...
       movieNameButton = new JButton(super.findMovieName(3));
       movienameJLabel = new JLabel("Name : "+super.findMovieName(3));
       ratingJLabel = new JLabel("IMDB Rating : "+super.findMovieRating(3));
       genreJLabel = new JLabel("Genre : "+super.findMovieGenre(3));
       showTimeJLabel = new JLabel("ShowTime : "+super.findMovieYear(3));
       ticketPriceJLabel = new JLabel("Ticket Price : "+super.findMoviePrice(3)+" Tk");
       ...
       Font newFont = new Font("serif", font.getStyle(), fontSize);
        ...
        movie = new ImageIcon(super.findMoviePath(3));
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==title){
           ...
           try{
               ...
               int value2 = Integer.parseInt(super.findMoviePrice(3));
               String totalprice = String.valueOf(value*value2);

               if(value<=4){
                   new Payment(super.findMovieName(3), user, totalprice, super.findMovieYear(3),value);
                   frame.setVisible(false);
               }
               else if(value>4){
